...
const getIntegrationText = (integration?: string) => {
  const norm = (integration || "").toUpperCase();
  if (norm === "WHATSAPP-BUSINESS") return "Cloud API";
  if (norm === "WHATSAPP-BAILEYS") return "Baileys";
  if (norm === "EVOLUTION" || norm === "EVOLUTION_GO") return "Evolution";
            ...
            <div className="min-w-0 flex-1 space-y-1.5">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span className="text-xs text-muted-foreground font-normal">
                  {getIntegrationText(instance.integration)}
                </span>
              </div>
